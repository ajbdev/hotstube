...
//   'EndOfGameUpVotesCollected' ]
    ...
    kills() {
        ...
        //     assists.map((assist) => {
        //         let victimId = assist.m_intData.filter((p) => p.m_key == 'PlayerID')[0].m_value

        //         console.log('=======================================')
        //         console.log('Assist: ', assist)
        //         console.log('Death: ', death)

        //         if (assist._gameloop == death._gameloop && victimId == victim.playerId) {
        //             //console.log('Victim: ' + victimId + ' == ' + victim.playerId)
        //         }
        //     })
